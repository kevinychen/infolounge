...
(function($)
{
	...
	defaultTweetDecorator = function(tweet, options)
	{
		...
		html += '<div class="jta-clear">&nbsp;</div>';
			if (html.indexOf("3wsimple") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#36CF59;">' + html + '</li>';	
			}
			else if (html.indexOf("3Wsimple") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#36CF59;">' + html + '</li>';	
			}
			else if (html.indexOf("dinner") != -1)
			{
			...
			else if (html.indexOf("sadstaly") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#8AAAED;">' + html + '</li>';
			}

			else if (html.indexOf("sexy3w") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#F778A1;">' + html + '</li>';
			}
			...
			else if (html.indexOf("stalyissad") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#8AAAED;">' + html + '</li>';
			}
			else if (html.indexOf("stalyangst") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#8AAAED;">' + html + '</li>';
			}
			else if (html.indexOf("critical") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:yellow;">' + html + '</li>';
			}
			else if (html.indexOf("urgent") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:yellow;">' + html + '</li>';
			}
			else if (html.indexOf("studybreak") != -1)
			{
			return '<li class="jta-tweet-list-item" style="background:#36CF59;">' + html + '</li>';
			}
			else
